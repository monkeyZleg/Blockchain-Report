...
<center><u>Figure 7.8.1: Withdraw Collateral</u></center>
```solidity
...
![Settings page showing the Account & Sign-in panel](asset/7.14-settings-account.png)
*Figure 7.14.1: Settings, Account & Sign-in*

![Settings page showing the Linked Wallet panel and the Unlink confirmation dialog](asset/7.14-settings-wallet.png)
